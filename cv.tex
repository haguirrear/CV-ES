...
\begin{tabular}{rl}
  ...
  \textsc{Address:} & \textsc{Av. San Martín 236 - Barranco - Lima} \\
  \textsc{Tel:} & +51 979277722\\
  \textsc{email:} & \href{mailto:hector.aguirre.arista@gmail.com}{hector.aguirre.arista@gmail.com}\\
...
Fast-learner and highly skilled Senior Backend Developer and Tech Lead with a proven track record of leading successful developer teams. Adept at designing and implementing distributed systems to drive efficiency and scalability. Proficient in Python, Dart, and Javascript, with hands-on experience in Docker and orchestration services. Well-versed in developing Rest and GraphQL APIs to deliver seamless user experiences. Fluent in both Spanish and English.

%Section: Work Experience at the top
\section{\raisebox{-.3\baselineskip}{\workLogo}Professional Experience}
\begin{longtable}{r|p{11cm}}

  \emph{Aug 2021 - now} & Integrations Team Tech Lead\\& \emph{Crehana}\\ & \footnotesize{The integrations between Crehana and other platforms took on more importance after the need of taking Crehana's courses into other applications and courses from external platforms into Crehana. Therefore, an Integrations team was created and I assumed the role of Tech Lead.  Within this role, I carried on projects to develop the integrations in a scalable way and navigate between all platforms easily. One of the key features was the implementation of an SSO process using \emph{SAML2} that allowed Crehana to behave as \emph{IDP} and \emph{SP}. I also used \emph{ElasticSearch} to be able to search quickly between the content of all the external platforms and \emph{serverless architecture} to synchronize the content. In this role, I also had the chance to guide my team in the development of several projects that also included the improvement of the way of work and the reduction of technical debt such as improvements in \emph{CI/CD pipelines}, and the implementation of \emph{GraphQL Federation} and \emph{Microservices Architecture}, etc.}\\&\\
  \emph{Aug 2021 - Nov 2021} & Senior Backend Developer\\& \emph{Crehana}\\ & \footnotesize{Crehana, a leading EdTech startup in Latin America, entrusted me with integrating their platform with  \emph{SAP Success Factors} (SAP's Learning Management System). To accomplish this, I utilized an  \emph{AWS Step Function} to synchronize courses from Crehana to SAP SF. Additionally, I set up events that triggered a Lambda function, leveraging SAP's APIs. AWS's SNS and SQS (with a DLQ) ensured seamless message processing. The project utilized Python \emph{, PostgreSQL, Flask, GraphQL}, and AWS.}\\&\\
